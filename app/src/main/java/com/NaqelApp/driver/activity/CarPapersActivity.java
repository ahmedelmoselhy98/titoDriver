...
import com.NaqelApp.driver.adapter.CategAdapter;
import com.NaqelApp.driver.model.CarModel;
import com.NaqelApp.driver.model.CategLocal;
import com.NaqelApp.driver.view.BottomDialog;
...
public class CarPapersActivity extends AppCompatActivity implements IPickResult {
    ...
    /**
     * here to add the data of the com.NaqelApp.com.NaqelApp.driver to the database after uploaded the image to the storage
     */
    ...
    private void selectcateg() {
        ...
        data.add(new CategLocal(R.drawable.winnch, "ونش", "نقل العربات", "-L_wEOtpCYemDnlzh7Ys"));
        data.add(new CategLocal(R.drawable.furntirure, "نقل اثاث", "نقل الاثاث باحترافية", "-Leuhw2vW9-CGQfsPr6h"));
        data.add(new CategLocal(R.drawable.constructions, "اسمنت", "طلب الاسمنت", "-Leuhy84ZJ8JjyC-TE7u"));
        data.add(new CategLocal(R.drawable.water, "مويه", "طلب المياه", "-Leui0WeXSxyMAounnuh"));
